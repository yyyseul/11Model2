...
function fncAddProduct(){
	...
	$("#addProdForm").attr("method","POST").attr("action", "/product/addProduct").attr("enctype","multipart/form-data").submit();
...
<!--  화면구성 div Start /////////////////////////////////////-->
	<div class="container">
		...
		<!-- form Start /////////////////////////////////////-->
		<form name="detailForm" id="addProdForm" class="form-horizontal">
